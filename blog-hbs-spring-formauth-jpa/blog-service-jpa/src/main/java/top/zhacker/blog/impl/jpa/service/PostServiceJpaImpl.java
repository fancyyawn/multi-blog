package top.zhacker.blog.impl.jpa.service;
...
import top.zhacker.blog.impl.jpa.repo.CommentRepo;
import top.zhacker.blog.impl.jpa.repo.PostRepo;
import top.zhacker.blog.impl.jpa.repo.UserRepo;
...
public class PostServiceJpaImpl implements PostService {
    ...
    public Response<Boolean> updatePostTitleAndContent(Long id, String title, String content) {
        try {
            postRepo.updateTitleAndContentById(id, title, content);
